...
from src.repositories import (RoleRepository, PermissionRepository, RolePermissionRepository)
...
class RoleService(AuditableService[Role, RoleRepository]):
    ...
    def __init__(
            ...
            p_repo: PermissionRepository, rp_repo: RolePermissionRepository):
    ...
    async def get_all_with_permissions(
            self, include_deleted: bool = False) -> List[Role]:
    ...
    async def generate_role_permission(
            self, data: CreateRolePermissionSchema,
            check_role_exists: bool = False) -> RolePermission:
    ...
    async def create_roles_permissions(
        ...
        for link_data in data:
            links.append(await self.generate_role_permission(
                CreateRolePermissionSchema(role_id=role_id,
